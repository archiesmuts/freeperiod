class Assessment < ApplicationRecord
  ...
  belongs_to :lesson_plan, inverse_of: :assessments
  belongs_to :assessment_type, inverse_of: :assessments
  belongs_to :assessment_task, inverse_of: :assessments
  ...
  validates :lesson_plan_id, :name, :value, :version, :assessment_type_id, :assessment_task_id, presence: true

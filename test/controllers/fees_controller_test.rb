...
class FeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post fees_url, params: { fee: { amount: @fee.amount, name: @fee.name, school_id: @fee.school_id, year: @fee.year } }
    end
  ...
  test "should update fee" do
    patch fee_url(@fee), params: { fee: { amount: @fee.amount, name: @fee.name, school_id: @fee.school_id, year: @fee.year } }

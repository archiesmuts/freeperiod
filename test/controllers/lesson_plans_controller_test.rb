...
class LessonPlansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create lesson_plan" do
    assert_difference('LessonPlan.count') do
      post lesson_plans_url, params: { lesson_plan: { name: @lesson_plan.name, registration_klass_id: @lesson_plan.registration_klass_id, term: @lesson_plan.term } }
    end
  ...
  test "should update lesson_plan" do
    patch lesson_plan_url(@lesson_plan), params: { lesson_plan: { name: @lesson_plan.name, registration_klass_id: @lesson_plan.registration_klass_id, term: @lesson_plan.term } }

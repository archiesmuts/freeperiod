...
class AchievementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create achievement" do
    assert_difference('Achievement.count') do
      post achievements_url, params: { achievement: { date: @achievement.date, description: @achievement.description, slug: @achievement.slug, title: @achievement.title } }
    end
  ...
  test "should update achievement" do
    patch achievement_url(@achievement), params: { achievement: { date: @achievement.date, description: @achievement.description, slug: @achievement.slug, title: @achievement.title } }

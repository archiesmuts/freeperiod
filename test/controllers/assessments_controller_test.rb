...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { assessment_type: @assessment.assessment_type, lesson_plan_id: @assessment.lesson_plan_id, name: @assessment.name } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { assessment_type: @assessment.assessment_type, lesson_plan_id: @assessment.lesson_plan_id, name: @assessment.name } }

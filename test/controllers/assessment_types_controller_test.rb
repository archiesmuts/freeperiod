...
class AssessmentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment_type" do
    assert_difference('AssessmentType.count') do
      post assessment_types_url, params: { assessment_type: { name: @assessment_type.name, slug: @assessment_type.slug } }
    end
  ...
  test "should update assessment_type" do
    patch assessment_type_url(@assessment_type), params: { assessment_type: { name: @assessment_type.name, slug: @assessment_type.slug } }

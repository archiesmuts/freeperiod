...
# add this later {name: "All Grades", slug: "all-grades"}
# subject_list = [
#   ["Afrikaans", "afrikaans"],
#   ["English", "english"],
#   ["French", "french"],
...
#   subject.courses.create(higher_grades.each {|grade| name: "#{grade.name} #{subject.name}", grade_id: "#{grade.id}", subject_type: 0})
# end

...
ActiveRecord::Schema.define(version: 2017_11_06_140826) do
  ...
  create_table "achievements", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_achievements_on_slug"
  end
  ...
  create_table "action_plans", force: :cascade do |t|
    ...
    t.index ["slug"], name: "index_action_plans_on_slug"
  end
  ...
  create_table "assessment_tasks", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_assessment_tasks_on_slug"
  end
  ...
  create_table "assessment_types", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_assessment_types_on_slug"
  end
  ...
  create_table "assessments", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["slug"], name: "index_assessments_on_slug"
  end
  ...
  create_table "attendances", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.index ["details"], name: "index_attendances_on_details", using: :gin
  end
  ...
  create_table "courses", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["details"], name: "index_courses_on_details", using: :gin
  ...
  create_table "fees", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["details"], name: "index_fees_on_details", using: :gin
    t.index ["slug"], name: "index_fees_on_slug"
  end
  ...
  create_table "lesson_plans", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["details"], name: "index_lesson_plans_on_details", using: :gin
    t.index ["slug"], name: "index_lesson_plans_on_slug"
  end

  create_table "memberships", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "user_id"
    t.uuid "school_id"
    t.integer "primary_role", default: 0, null: false
    t.string "slug", null: false
    t.jsonb "details", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "pay_agreements", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["details"], name: "index_pay_agreements_on_details", using: :gin
    t.index ["slug"], name: "index_pay_agreements_on_slug"
  end
  ...
  create_table "registration_klasses", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["data"], name: "index_registration_klasses_on_data", using: :gin
    t.index ["slug"], name: "index_registration_klasses_on_slug"
  end
  ...
  create_table "schools", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.text "description"
    t.string "slug", null: false
    t.jsonb "prospectus", default: {}, null: false
    t.jsonb "preferences", default: {}, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["preferences"], name: "index_schools_on_preferences", using: :gin
    t.index ["prospectus"], name: "index_schools_on_prospectus", using: :gin
  ...
  create_table "subjects", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["details"], name: "index_subjects_on_details", using: :gin
  ...
  create_table "user_registrations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["details"], name: "index_user_registrations_on_details", using: :gin
    t.index ["slug"], name: "index_user_registrations_on_slug"
  end
